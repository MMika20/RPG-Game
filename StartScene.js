class StartScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(140, 310, 'In dieser Welt kannst du frei rum laufen und erkunden ', { fontSize: '25px' });
        this.add.text(200, 340, 'was auch immer du willst. Nur pass auf das du', { fontSize: '25px' });
